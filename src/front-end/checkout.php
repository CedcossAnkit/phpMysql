      ...
      <div class="row g-5">
        <div class="col-md-5 col-lg-4 order-md-last">
          ...
          <ul class="list-group mb-3">
            ...
            {
                echo $myobj->showCartItemCheckout();
            }
            ?>
          </ul>
        ...
        <div class="col-md-7 col-lg-8">
          ...
          <form class="needs-validation" novalidate>
            ...
            <div class="my-3">
              <div class="form-check">
                <input id="credit" name="paymentMethod" type="radio" class="form-check-input" id="CC" value="Credit Card" required>
            ...
            <button class="w-100 btn btn-primary btn-lg" id="placeorderBTN" type="submit">Place Order</button>
          </form>
        </div>
      </div>
    </main>
